...
public class EmailRepositoryImplSQL implements  EmailRepository{
    ...
    public void updateEmailsStatus(String status,long seqID){
        try
        {
            String sql = "UPDATE email_queue SET STS = ?, UPD_DT = GETDATE() WHERE SEQ_ID = ?;";
    ...
    public long createEmail(Email email){
        try
        {
            ...
            String sql = "INSERT INTO email_queue(INV_ID,STS,CR_DT,BUYER_EMAIL) VALUES (?,'C',GETDATE(),?);";
